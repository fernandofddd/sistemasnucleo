      ...
      <div class="form-group">
        ...
        <div class="row">
            <div class="col-xs-6 col-sm-6 col-md-6">
                ...
                <input type="text" name="Primer_Nombre" id="Primer_Nombre" value="{{old('Primer_Nombre')}}" class="form-control" placeholder="Primer Nombre" tabindex="1">
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-xs-6 col-sm-6 col-md-6">
                ...
                <input type="text" name="Segundo_Nombre" id="Segundo_Nombre" value="{{old('Segundo_Nombre')}}" class="form-control" placeholder="Segundo_Nombre" tabindex="3">
                </div>
            </div>
            ...
            <div class="col-xs-6 col-sm-6 col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="Segundo_Apellido" id="Segundo_Apellido" value="{{old('Segundo_Apellido')}}" class="form-control" placeholder="Segundo_Apellido" tabindex="4">
                </div>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-xs-6 col-sm-6 col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="Cedula" id="Cedula" value="{{old('Cedula')}}" class="form-control" placeholder="Cedula" tabindex="7">
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-xs-6 col-sm-6 col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="Fecha_Nacimiento" id="Fecha_Nacimiento" value="{{old('Fecha_Nacimiento')}}" class="form-control" placeholder="Fecha de Nacimiento" tabindex="9">
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-xs-6 col-md-6"><input type="submit" value="Guardar" class="btn btn-danger btn-block btn-lg" tabindex="13"
